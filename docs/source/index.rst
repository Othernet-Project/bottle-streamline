...
<https://github.com/Outernet-Project/bottle-streamline>`_.

License
-------

bottle-streamline is released under BSD license. See the ``LICENSE`` file that
...
<https://github.com/Outernet-Project/bottle-streamline/issues>`_.
